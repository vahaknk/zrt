...
// child, so "Understands" becomes "I understand", etc. Transcribed from the
// separate adult Notion form (database b11ad72f-b9ef-8383-b88c-81270b3b8a4d).
export const ADULT_PROFICIENCY_OPTIONS: FormOption[] = [
  { value: 'none', notionName: 'Բնաւ չեմ գիտեր: Je ne connais pas du tout. I do not know at all.',
    label: { hyw: 'Բնաւ չեմ գիտեր', fr: 'Je ne connais pas du tout.', en: 'I do not know at all.' } },
  { value: 'understands_little', notionName: 'Քիչ մը կը հասկնամ: Je comprends un peu. I understand a little.',
    label: { hyw: 'Քիչ մը կը հասկնամ', fr: 'Je comprends un peu.', en: 'I understand a little.' } },
  { value: 'speaks_little', notionName: 'Քիչ մը կը խօսիմ: Je parle un peu. I speak a little.',
    label: { hyw: 'Քիչ մը կը խօսիմ', fr: 'Je parle un peu.', en: 'I speak a little.' } },
  { value: 'reads_writes_little', notionName: "Քիչ մը կը գրեմ ու կը կարդամ: Je lis et j'écris un peu. I read and write a little.",
    label: { hyw: 'Քիչ մը կը գրեմ ու կը կարդամ', fr: "Je lis et j'écris un peu.", en: 'I read and write a little.' } },
  { value: 'understands', notionName: 'Կը հասկնամ: Je comprends. I understand.',
    label: { hyw: 'Կը հասկնամ', fr: 'Je comprends.', en: 'I understand.' } },
  { value: 'speaks', notionName: 'Կը խօսիմ: Je parle. I speak.',
    label: { hyw: 'Կը խօսիմ', fr: 'Je parle.', en: 'I speak.' } },
  { value: 'reads_writes', notionName: "Կը գրեմ ու կը կարդամ: Je lis et j'écris. I read and write.",
    label: { hyw: 'Կը գրեմ ու կը կարդամ', fr: "Je lis et j'écris.", en: 'I read and write.' } },
  { value: 'understands_easily', notionName: 'Շատ հանգիստ կը հասկնամ: Je comprends très facilement. I understand very easily.',
    label: { hyw: 'Շատ հանգիստ կը հասկնամ', fr: 'Je comprends très facilement.', en: 'I understand very easily.' } },
  { value: 'speaks_fluently', notionName: 'Շատ հանգիստ կը խօսիմ: Je parle très couramment. I speak very fluently.',
    label: { hyw: 'Շատ հանգիստ կը խօսիմ', fr: 'Je parle très couramment.', en: 'I speak very fluently.' } },
  { value: 'reads_writes_easily', notionName: "Շատ հանգիստ կը գրեմ ու կը կարդամ: Je lis et j'écris très facilement. I read and write very easily.",
    label: { hyw: 'Շատ հանգիստ կը գրեմ ու կը կարդամ', fr: "Je lis et j'écris très facilement.", en: 'I read and write very easily.' } },
  { value: 'other', notionName: 'Այլ։ Autre. Other.',
    label: { hyw: 'Այլ', fr: 'Autre.', en: 'Other.' } },
];
...
export const RELATIONSHIP_OPTIONS: FormOption[] = [
  ...
  { value: 'guardian', notionName: 'Պաշտօնական պատասխանատուն եմ։ Je suis le responsable légal. I am the legal guardian.',
    label: { hyw: 'Պաշտօնական պատասխանատուն եմ', fr: 'Je suis le responsable légal.', en: 'I am the legal guardian.' } },
  { value: 'other', notionName: 'Այլ։ Autre. Other.',
    label: { hyw: 'Այլ', fr: 'Autre.', en: 'Other.' } },
];
...
export const FIELD_LABELS: Record<Lang, Record<string, string>> = {
  hyw: {
    ...
    participant_birthday_adult: 'Ձեր ծննդեան թուականը',
    ...
    proficiency_adult: 'Ձեր լեզուական պատրաստութիւնը',
    interests: 'Մասնակիցին հետաքրքրութիւնները',
    interests_adult: 'Ձեր հետաքրքրութիւնները',
    ...
    invalid_birthday: 'Խնդրենք մուտքագրել վաւերական թուական՝ ՕՕ/ԱԱ/ՏՏՏՏ ձեւաչափով։',
  ...
  fr: {
    ...
    participant_birthday_adult: 'Votre date de naissance',
    ...
    proficiency_adult: 'Votre maîtrise de la langue',
    interests: "Centres d'intérêt du/de la participant.e",
    interests_adult: "Votre centres d'intérêt",
    ...
    availability_title_adult: 'Jours et heures qui vous conviennent',
    availability_hint: 'Après avoir sélectionné votre fuseau horaire, nous vous prions d՛indiquer sur l\'emploi du temps **toutes les plages horaires** qui vous conviennent. Afin de faciliter la coordination avec les autres participants, merci de sélectionner autant de disponibilités que possible.',
    ...
    invalid_birthday: 'Veuillez saisir une date valide au format JJ/MM/AAAA.',
  ...
  en: {
    ...
    participant_birthday_adult: 'Your birthday',
    ...
    proficiency_adult: 'Your language proficiency',
    interests: "Participant's interests",
    interests_adult: 'Your interests',
    ...
    availability_title_adult: 'Days and times that work for you',
    availability_hint: 'After selecting your time zone, please mark **all the times** that work for you on the schedule. To help us coordinate better with other participants, please select as many available times as possible.',
    ...
    invalid_birthday: 'Please enter a valid date in DD/MM/YYYY format.',
